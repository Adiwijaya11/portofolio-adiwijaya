...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center pt-20 pb-12 overflow-hidden relative">
      ...
      {/* 3. Animated Glowing Orbs (Mesh Gradient Effect) - Optimized with lower blur and opacity for peak performance */}
      <div className="absolute top-0 -left-10 md:left-1/4 w-[250px] sm:w-[450px] h-[250px] sm:h-[450px] bg-amber-400/15 dark:bg-amber-500/5 rounded-full blur-[40px] sm:blur-[60px] animate-blob z-[-1] pointer-events-none"></div>
      <div className="absolute top-1/4 -right-10 md:right-1/4 w-[300px] sm:w-[550px] h-[300px] sm:h-[550px] bg-orange-400/15 dark:bg-orange-600/5 rounded-full blur-[40px] sm:blur-[60px] animate-blob animation-delay-2000 z-[-1] pointer-events-none"></div>
      <div className="absolute -bottom-20 left-1/3 w-[200px] sm:w-[350px] h-[200px] sm:h-[350px] bg-blue-400/15 dark:bg-blue-600/5 rounded-full blur-[40px] sm:blur-[60px] animate-blob animation-delay-4000 z-[-1] pointer-events-none"></div>
      {/* ------------------------------- */}
